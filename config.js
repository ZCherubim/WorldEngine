...
export const DEFAULT_SETTINGS = {
    ...
    api: {
        ...
        temperature: 0.45,
        maxTokens: 4096,
        // 单次请求超时（毫秒）。v2.3.26：之前写死 120 秒，慢中转（gemini 系代理实测
        // 单轮 40~105 秒）经常被拦腰掐断，报 "signal is aborted without reason"。
        timeoutMs: 300000,
    ...
    tracking: {
        ...
        rivalGap: 3,         // v2.4.0：关系线对手超过几层没出手就算「停滞」，会被攻防指令硬点名
    ...
    inject: {               // 上下文注入
        ...
        mode: 'active',     // v2.4.0 注入强度：passive=被动背景 / active=主动钩子（默认）/ director=强导演
    },
    prompts: {
